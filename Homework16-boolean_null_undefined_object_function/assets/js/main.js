 ...
 */
 ...
 console.log("объект userObj:", userObj);
...
console.log("fullName is ", userObj.fullName())
/*
 * #3
 *
...
function defUpperStr(str){
    return String(str||"Default text").toUpperCase();
...
function ageClassification(n){
    return (n > 0 && n <=24)? 'детский возраст' : (n > 24 && n <=44) ? 'молодой возраст': (n > 44 && n <=65) ? 'средний возраст': (n > 65 && n <=75) ? 'пожилой возраст':
